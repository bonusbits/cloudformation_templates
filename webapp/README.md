    ...
    <tr>
        <td colspan="2">
            <table>
                ...
                <tr>
                    <td>
                        <h6>Option 1 - Custom Parameters JSON File <a href="https://github.com/bonusbits/cloudformation_templates/blob/master/webapp/example_parameters/autoscaling-bakedami-rdsbackend">(Example Here)</a></h6>
    ...
    <tr>
        <td colspan="2">
            <table>
                ...
                <tr>
                    <td>
                        <h6>Option 1 - Custom Parameters JSON File <a href="https://github.com/bonusbits/cloudformation_templates/blob/master/webapp/example_parameters/autoscaling-bakedami">(Example Here)</a></h6>
                        <code>--parameters file:///localpath/to/custom-parameters.json</code>
                    </td>
                </tr>
                <tr>
